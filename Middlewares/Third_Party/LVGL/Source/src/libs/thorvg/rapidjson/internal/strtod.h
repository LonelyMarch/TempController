...
namespace internal
{
    ...
    inline bool StrtodDiyFp(const Ch* decimals, int dLen, int dExp, double* result)
    {
        ...
        *result = rounded.ToDouble();
        ...
        return halfWay - static_cast<unsigned>(error) >= precisionBits || precisionBits >= halfWay + static_cast<
            unsigned>(error);
    }
    ...
    template <typename Ch>
    inline double StrtodFullPrecision(double d, int p, const Ch* decimals, size_t length, size_t decimalPosition,
                                      int exp)
    {
