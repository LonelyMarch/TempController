 ...
 */
    enum class CompositeMethod
    {
        ...
        LumaMask,
        ///< Alpha Masking using the grayscale (0.2125R + 0.7154G + 0.0721*B) of the compositing target's pixels. @since 0.9
        InvLumaMask,
        ///< Alpha Masking using the grayscale (0.2125R + 0.7154G + 0.0721*B) of the complement to the compositing target's pixels. @since 0.11
        AddMask,
 ...
 */
     ...
     */
        enum Colorspace
        {
            ...
            ABGR8888S,
            ///< The channels are joined in the order: alpha, blue, green, red. Colors are un-alpha-premultiplied. @since 0.12
            ARGB8888S,
            ///< The channels are joined in the order: alpha, red, green, blue. Colors are un-alpha-premultiplied. @since 0.12
        };
 ...
 */
     ...
     * @note Experimental API
     */
        Result set(const Picture* picture, std::function<bool(const Paint* paint, void* data)> func,
                   void* data) noexcept;
