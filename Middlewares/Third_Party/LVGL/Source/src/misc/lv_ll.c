...
void* lv_ll_ins_head(lv_ll_t* ll_p)
{
    ...
    if (n_new != NULL)
    {
        ...
        if (ll_p->tail == NULL)
        {
            /*If there is no tail (1. node) set the tail too*/
            ll_p->tail = n_new;
        }
    }
...
void* lv_ll_ins_tail(lv_ll_t* ll_p)
{
    ...
    if (n_new != NULL)
    {
        ...
        if (ll_p->tail != NULL)
        {
            /*If there is old tail then the new comes after it*/
...
void lv_ll_chg_list(lv_ll_t* ll_ori_p, lv_ll_t* ll_new_p, void* node, bool head)
{
    ...
    if (head)
    {
        ...
        {
            /*If there is no tail (first node) set the tail too*/
            ll_new_p->tail = node;
        }
    }
    else
    {
        ...
        if (ll_new_p->head == NULL)
        {
            /*If there is no head (first node) set the head too*/
            ll_new_p->head = node;
        }
    }
}
